...
// Phase 4 refinement + OLED bitmap icons
...
// ============================================================
// 16x16 PROGMEM bitmap icons for OLED display
// Each icon is 32 bytes (16 rows x 2 bytes/row, MSB first)
// Designed for classroom-friendly visual status at a glance
// ============================================================

// Movement icon: up arrow (forward)
static const unsigned char PROGMEM icon_forward[] = {
  0x01, 0x80,  // ......##........
  0x03, 0xC0,  // .....####.......
  0x07, 0xE0,  // ....######......
  0x0F, 0xF0,  // ...########.....
...
// Movement icon: down arrow (backward)
static const unsigned char PROGMEM icon_backward[] = {
  0x00, 0x00,  // ................
  0x00, 0x00,  // ................
  0x07, 0xE0,  // ....######......
  0x07, 0xE0,  // ....######......
...
// Movement icon: left arrow (turning left)
...
// Movement icon: right arrow (turning right)
...
// Movement icon: pause bars (idle/stopped)
static const unsigned char PROGMEM icon_stopped[] = {
  0x00, 0x00,  // ................
  0x00, 0x00,  // ................
  0x3C, 0x3C,  // ..####....####..
  0x3C, 0x3C,  // ..####....####..
...
// Movement icon: checkmark (done)
static const unsigned char PROGMEM icon_done[] = {
  0x00, 0x00,  // ................
  0x00, 0x06,  // .............##.
  0x00, 0x0E,  // ............###.
  0x00, 0x1C,  // ...........###..
...
// Movement icon: X mark (timeout)
static const unsigned char PROGMEM icon_timeout[] = {
  0x00, 0x00,  // ................
  0x40, 0x02,  // .#............#.
  0x60, 0x06,  // .##..........##.
  0x30, 0x0C,  // ..##........##..
...
// Movement icon: warning triangle with ! (stall)
static const unsigned char PROGMEM icon_stall[] = {
  0x00, 0x00,  // ................
  0x01, 0x80,  // .......##.......
  0x01, 0x80,  // .......##.......
  0x03, 0xC0,  // ......####......
...
// Connection icon: WiFi signal arcs with dot
...
// Connection icon: WiFi with X (no connection)
static const unsigned char PROGMEM icon_no_wifi[] = {
  0x00, 0x00,  // ................
  0x07, 0xE2,  // .....######...#.
  0x1F, 0xF4,  // ...##########.#.
  0x38, 0x1C,  // ..###......###..
...
// Connection icon: chip/MCU shape (Arduino OK)
static const unsigned char PROGMEM icon_arduino_ok[] = {
  0x00, 0x00,  // ................
  0x55, 0x54,  // .#.#.#.#.#.#.#..
  0x7F, 0xFC,  // .#############..
  0x40, 0x04,  // .#..........#...
...
// Connection icon: chip with X (Arduino disconnected)
static const unsigned char PROGMEM icon_arduino_no[] = {
  0x00, 0x00,  // ................
  0x55, 0x54,  // .#.#.#.#.#.#.#..
  0x7F, 0xFC,  // .#############..
  0x60, 0x0C,  // .##.........##..
...
// ============================================================
// 32x32 PROGMEM bitmap icons for large center display
// Each icon is 128 bytes (32 rows x 4 bytes/row, MSB first)
// ============================================================

// Large forward arrow (32x32)
static const unsigned char PROGMEM icon_forward_lg[] = {
  0x00, 0x01, 0x80, 0x00,  // ...............##...............
  0x00, 0x03, 0xC0, 0x00,  // ..............####..............
  0x00, 0x07, 0xE0, 0x00,  // .............######.............
  0x00, 0x0F, 0xF0, 0x00,  // ............########............
...
// Large backward arrow (32x32)
static const unsigned char PROGMEM icon_backward_lg[] = {
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x0F, 0xF0, 0x00,
  0x00, 0x0F, 0xF0, 0x00,
...
// Large left arrow (32x32)
static const unsigned char PROGMEM icon_left_lg[] = {
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x02, 0x00, 0x00,
  0x00, 0x06, 0x00, 0x00,
  0x00, 0x0E, 0x00, 0x00,
...
// Large right arrow (32x32)
static const unsigned char PROGMEM icon_right_lg[] = {
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x40, 0x00,
  0x00, 0x00, 0x60, 0x00,
  0x00, 0x00, 0x70, 0x00,
...
// Large pause bars (32x32)
static const unsigned char PROGMEM icon_stopped_lg[] = {
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00,
...
// Large checkmark (32x32)
static const unsigned char PROGMEM icon_done_lg[] = {
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x0C,
  0x00, 0x00, 0x00, 0x1C,
...
// Large X mark (32x32)
static const unsigned char PROGMEM icon_timeout_lg[] = {
  0x00, 0x00, 0x00, 0x00,
  0x30, 0x00, 0x00, 0x0C,
  0x38, 0x00, 0x00, 0x1C,
  0x1C, 0x00, 0x00, 0x38,
...
// Large warning triangle (32x32)
static const unsigned char PROGMEM icon_stall_lg[] = {
  0x00, 0x01, 0x80, 0x00,
  0x00, 0x01, 0x80, 0x00,
  0x00, 0x03, 0xC0, 0x00,
  0x00, 0x03, 0xC0, 0x00,
...
// Helper: map motor status string to the correct 16x16 icon (for top bar)
const unsigned char* getMotorIcon(const String& status) {
  if (status == "FORWARD")  return icon_forward;
  if (status == "BACKWARD") return icon_backward;
  if (status == "LEFT")     return icon_left;
  if (status == "RIGHT")    return icon_right;
  if (status == "DONE")     return icon_done;
  if (status == "TIMEOUT")  return icon_timeout;
  if (status == "STALL")    return icon_stall;
  return icon_stopped;
}

// Helper: map motor status string to the large 32x32 icon (for center)
const unsigned char* getMotorIconLg(const String& status) {
  if (status == "FORWARD")  return icon_forward_lg;
  if (status == "BACKWARD") return icon_backward_lg;
  if (status == "LEFT")     return icon_left_lg;
  if (status == "RIGHT")    return icon_right_lg;
  if (status == "DONE")     return icon_done_lg;
  if (status == "TIMEOUT")  return icon_timeout_lg;
  if (status == "STALL")    return icon_stall_lg;
  return icon_stopped_lg;
}
...
void oledTask(void* parameter) {
  ...
  for (;;) {
    ...
    // Top bar: WiFi (left) + Arduino (right) small icons
    ...
    // Center: large 32x32 direction icon (centered at x=16, y=38)
    oled.drawBitmap(16, 38, getMotorIconLg(motorStatus), 32, 32, SSD1306_WHITE);

    // Divider line above bottom info
    oled.drawLine(4, 100, 60, 100, SSD1306_WHITE);

    // Bottom: Dist + Heap stacked, centered small text
    oled.setTextSize(1);
    oled.setTextColor(SSD1306_WHITE);
    ...
    snprintf(line, sizeof(line), "Dist:%dcm", currentDistance);
    px = (64 - (int)strlen(line) * 6) / 2;
    oled.setCursor(px, 106);
    oled.print(line);

    snprintf(line, sizeof(line), "Heap:%dK", (int)(ESP.getFreeHeap() / 1024));
    px = (64 - (int)strlen(line) * 6) / 2;
    oled.setCursor(px, 118);
    oled.print(line);
